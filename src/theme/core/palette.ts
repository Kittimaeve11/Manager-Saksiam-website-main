...
export const textDark = createPaletteChannel({
  primary: grey[100],
  secondary: grey[400],
  disabled: grey[200],
});

export const backgroundDark = createPaletteChannel({
  paper: grey[700],
  default: grey[800],
  neutral: grey[900],
});
...
export const colorSchemes: Partial<Record<'light' | 'dark', ColorSystemOptions>> = {
  ...
  dark: { palette: darkPalette }, // คุณต้องสร้าง darkPalette ด้วย (เดี๋ยวแนะนำ)
};